...
URL = 'http://s.weibo.com/weibo?q={}&scope=ori&suball=1&page={}'
...
def search_keyword(keyword, keyword_id):
    ...
    while cur_page < LIMIT:
        ...
        search_page = get_page(cur_url, auth_level=2, need_proxy=True)
        if not search_page:
        ...
        for wb_data in search_list:
            ...
            try:
                ...
                crawler.error('get attribute error, the detail is {}'.format(e))
