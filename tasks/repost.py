...
def crawl_repost_by_page(mid, page_num):
    ...
    if page_num == 1:
        wb_data.set_weibo_repost_crawler(mid)
...
def execute_repost_task():
    ...
    for weibo_data in weibo_datas:
        app.send_task('tasks.repost.crawl_repost_page', args=(weibo_data.weibo_id, weibo_data.uid), queue='repost_crawler', routing_key='repost_info')
