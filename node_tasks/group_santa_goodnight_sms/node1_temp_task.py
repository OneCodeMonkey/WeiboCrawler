...
STARTTIME = '2019-12-25 13:00:00'
ENDTIME = '2019-12-25 21:00:00'
KEYWORD = '#圣诞晚安短信#'
...
while 1:
    ...
    time1 = start_time
    time2 = start_time + OneHour
    end_time = datetime.datetime.strptime(time.strftime('%Y-%m-%d',time.localtime(time.time())) + ' 23:00:00', "%Y-%m-%d %H:%M:%S")
