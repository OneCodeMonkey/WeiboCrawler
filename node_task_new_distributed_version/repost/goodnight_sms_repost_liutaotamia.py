...
source_weibo_id = 4442622422300558      # 源微博的weibo_id
source_user_id = 1197191492     # 源微博的user_id
scrapyed = []
unscrapyed = []
...
while count < maxRecursiveTimes:
    ...
    result2 = db_session.query(WeiboRepost.weibo_id, WeiboRepost.user_id).filter(and_(WeiboRepost.root_weibo_id == source_weibo_id, WeiboRepost.parent_user_id.in_(unqueryedUid))).all()
